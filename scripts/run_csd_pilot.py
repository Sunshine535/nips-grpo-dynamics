...
Usage:
  ...
  python scripts/run_csd_pilot.py --pilot all --model Qwen/Qwen3-8B

  # Run specific pilot
  python scripts/run_csd_pilot.py --pilot 1 --model Qwen/Qwen3-8B
  python scripts/run_csd_pilot.py --pilot 2 --model Qwen/Qwen3-8B --seeds 5
  python scripts/run_csd_pilot.py --pilot 3 --model Qwen/Qwen3-8B --seeds 10

  # Quick test (fewer steps)
  QUICK=1 python scripts/run_csd_pilot.py --pilot all --model Qwen/Qwen3-8B
"""

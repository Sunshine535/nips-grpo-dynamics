...
An ablation replacing positive CE replay with a DPO-style contrastive pair loss yields only 49.0\%, confirming that positive supervised replay outperforms pairwise negative contrast in this setting.
\end{abstract}

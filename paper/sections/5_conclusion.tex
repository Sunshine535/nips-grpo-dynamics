...
The high variance of TASA (std = 9.5 pp across 4 seeds) suggests that the method is sensitive to training dynamics, and further investigation into stabilization is warranted.
